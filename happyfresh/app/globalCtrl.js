 app.controller('globalCtrl', function ($scope, $modal, $filter, $timeout, $templateCache, improveService, variableService, Data, _) {
    ...
    {   id:1, title: 'LIST & FAVORITES', pid:0, heading: true },
   	  {   id:2, title: 'Recommended', pid:1, indent: true },
   	  ...
   	  {   id:9, title: 'My Favorites', pid:1, indent: true},

   	{   id:10, title: 'CATEGORIES', pid:0, heading: true},
   	   {   id:11, title: 'Specials', pid:10, indent: true },
   	   {   id:12, title: 'Fresh Produce', pid:10, indent: true },
   	   ...
   	   {   id:17, title: 'Meat & SeaFood', pid:10, indent: true },
   	   {   id:18, title: 'Deli', pid:10, indent: true },
   	   {   id:19, title: 'Bakery', pid:10, indent: true },
   	   {   id:20, title: 'Dairy', pid:10, indent: true },
   	   {   id:21, title: 'Dry & Canned Goods',pid:10, indent: true },
   	   {   id:22, title: 'Pantry', pid:10, indent: true },
   	   {   id:23, title: 'Beverages', pid:10, indent: true },
   	   {   id:24, title: 'Snacks', pid:10, indent: true },
   	   {   id:25, title: 'Frozen', pid:10, indent: true },
   	   {   id:26, title: 'Health & Beauty', pid:10, indent: true },
   	   {   id:27, title: 'Babies', pid:10, indent: true },
   	   {   id:28, title: 'Pets', pid:10, indent: true },
   	   {   id:29, title: 'Household', pid:10, indent: true },
   	   {   id:30, title: 'Ready to eat', pid:10, indent: true },
